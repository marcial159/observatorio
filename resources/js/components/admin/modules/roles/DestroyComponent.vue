<template>
    <div class="modal fade" id="roleDestroyModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form @submit="destroyEvent" id="roleDestroyForm">
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="form-label">¿Seguro que quiere eliminar el rol <strong>"{{ element?.name }}"</strong>?</label>
                            </div>
                        </div>
                        <div class="row">
...
export default
{
    ...
    mounted()
    {
        this.modal = new bootstrap.Modal( document.getElementById( `roleDestroyModal` ) )
        this.form = document.getElementById( `roleDestroyForm` )
    },
    ...
    methods:
    {
        ...
        destroyEvent( e )
        {
            ...
            this.axios.delete( `${this.$uri}/role/${this.element.id}` )
            .then( response =>
            {
                this.modal.hide()
