<template>
    <div class="modal fade" id="stageUpdateModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <h5 class="modal-title text-sm d-inline-block">
                                ...
                                Modificar estado proyecto
                            </h5>
                        </div>
                    </div>
                    <form @submit="updateEvent" id="stageFormUpdate" class="position-relative">
                        <div class="row">
...
export default
    {
        ...
        mounted() {
            this.modal = new bootstrap.Modal(document.getElementById(`stageUpdateModal`))
            this.form = document.getElementById(`stageFormUpdate`)
        },
        ...
        methods:
        {
            update(element) {
                ...
                this.axios.get(`${this.$uri}/project-stage/${element.id}`)
                    .then(response => {
            ...
            updateEvent(e) {
                ...
                this.axios.put(`${this.$uri}/project-stage/${this.element.id}`, data)
                    .then(response => {
                        this.modal.hide()
