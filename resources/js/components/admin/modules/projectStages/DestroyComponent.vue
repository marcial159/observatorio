<template>
    <div class="modal fade" id="stageDestroyModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form @submit="destroyEvent" id="stageDestroyForm">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="form-label">¿Seguro que quiere eliminar este estado <strong>"{{ element?.name }}"</strong>?</label>
                            </div>
                        </div>
                        <div class="row">
...
export default
{
    ...
    mounted()
    {
        this.modal = new bootstrap.Modal(document.getElementById( `stageDestroyModal` ))
        this.form = document.getElementById( `stageDestroyForm` )
    },
    ...
    methods:
    {
        ...
        destroyEvent( e )
        {
            ...
            this.axios.delete( `${this.$uri}/project-stage/${this.element.id}` )
            .then( response =>
            {
                this.modal.hide()
