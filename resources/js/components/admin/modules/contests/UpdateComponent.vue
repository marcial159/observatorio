<template>
    <div class="modal fade" id="contestUpdateModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form @submit="updateEvent" id="contestFormUpdate" class="position-relative">
                        <div class="row">
...
export default
    {
        ...
        mounted() {
            this.modal = new bootstrap.Modal(document.getElementById(`contestUpdateModal`))
            this.form = document.getElementById(`contestFormUpdate`)
        },
        ...
        methods:
        {
            update(element) {
                ...
                this.axios.get(`${this.$uri}/contest/${element.id}`)
                    .then(response => {
            ...
            updateEvent(e) {
                ...
                this.axios.put(`${this.$uri}/contest/${this.element.id}`, data)
                    .then(response => {
                        this.modal.hide()
