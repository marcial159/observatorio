<template>
    <div class="modal fade" id="contestDestroyModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form @submit="destroyEvent" id="contestDestroyForm">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="form-label">¿Seguro que quiere eliminar este concurso <strong>"{{ element?.name }}"</strong>?</label>
                            </div>
                        </div>
                        <div class="row">
...
export default
{
    ...
    mounted()
    {
        this.modal = new bootstrap.Modal(document.getElementById( `contestDestroyModal` ))
        this.form = document.getElementById( `contestDestroyForm` )
    },
    ...
    methods:
    {
        ...
        destroyEvent( e )
        {
            ...
            this.axios.delete( `${this.$uri}/contest/${this.element.id}` )
            .then( response =>
            {
                this.modal.hide()
