<template>
    <div class="modal fade" id="contestStoreModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form @submit="storeEvent" id="contestForm" class="position-relative">
                        <div class="row">
...
export default
    {
        ...
        mounted() {
            this.modal = new bootstrap.Modal(document.getElementById(`contestStoreModal`))
            this.form = document.getElementById(`contestForm`)
        },
        ...
        methods:
        {
            ...
            storeEvent(e) {
                ...
                this.axios.post(`${this.$uri}/contest`, data)
                    .then(response => {
                        vuenisimo.clearData(this.form)
                        this.modal.hide()
