            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 text-start animate__animated animate__fadeInDown">
                        <h6>
                            <i class="lni lni-users text-success me-2"></i>ADMINISTRACIÓN DE CONCURSOS
                        </h6>
                    </div>
                ...
                <div class="row position-relative" id="contestArea">
...
export default
    {
        ...
        mounted() {
            this.area = document.getElementById(`contestArea`)
        },
        ...
        methods:
        {
            ...
            async listing() {
                ...
                await this.axios.post(`${this.$uri}/contest/list?page=${this.page}`, this.filters)
                    .then(response => {
