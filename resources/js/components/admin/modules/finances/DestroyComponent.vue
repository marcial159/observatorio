<template>
    <div class="modal fade" id="userDestroyModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                <form @submit="destroyEvent" id="userDestroyForm">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label class="form-label">¿Seguro que quiere eliminar este rubro <strong>"{{ element?.item.name }}"</strong>?</label>
                            </div>
                        </div>
                        <div class="row">
...
export default
{
    ...
    mounted()
    {
        this.modal = new bootstrap.Modal(document.getElementById( `userDestroyModal` ))
    ...
    methods:
    {
        ...
        destroyEvent( e )
        {
            ...
            this.axios.delete( `${this.$uri}/project-item/${this.element.id}` )
            .then( response =>
            {
                this.modal.hide()
