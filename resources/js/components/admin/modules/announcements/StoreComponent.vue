                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-5">
                                ...
                                <input type="text" name="title" class="form-control form-control-sm" maxlength="30" autocomplete="off" required>
                                <p error="title" class="error"></p>
                            </div>
                            <div class="col-7">
                                <label class="form-label">Tipo de Proyecto (*)</label>
                                <input type="text" name="type_project" class="form-control form-control-sm" maxlength="40" autocomplete="off" required>
                                <p error="type_project" class="error"></p>
                            </div>
                            <div class="col-7">
                                <label class="form-label">Resolusion (*)</label>
                                <input type="text" name="resolution" class="form-control form-control-sm" maxlength="40" autocomplete="off" required>
...
export default
{
    ...
    methods:
    {
        ...
        storeEvent( e )
        {
            ...
            vuenisimo.clearError( this.form )
            this.axios.post( `${this.$uri}/announcement`, data )
            .then( response =>
            {
                vuenisimo.clearData( this.form )
                this.modal.hide()
