<template>
    <div class="position-absolute container-fluid" v-show="keys.includes( `announcement.list` )">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6 text-start animate__animated animate__fadeInDown">
                        <h6>
                            <i class="lni lni-map-marker text-success me-2"></i>Concursos
                        </h6>
                    </div>
                    <div class="col-6 text-end mb-4">
                        ...
                        <button class="btn btn-sm btn-success mb-0" v-show="keys.includes( `announcement.store` )" @click="$refs.StoreComponent.store()">
                ...
                <div class="row position-relative" id="announcementArea">
                    <table-component
                    :data="list.data"
...
export default
{
    ...
    mounted()
    {
        this.area = document.getElementById( `announcementArea` )
    },
    ...
    methods:
    {
        listing()
        {
            ...
            this.axios.post( `${this.$uri}/announcement/list?page=${this.page}`, this.filters )
            .then( response =>
            {
