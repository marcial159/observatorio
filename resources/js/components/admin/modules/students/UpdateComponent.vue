                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-5">
                                ...
                                <input type="text" name="peron_id" class="form-control form-control-sm" maxlength="30" autocomplete="off" required>
...
export default
{
    ...
    methods:
    {
        update( element )
        {
            ...
            this.axios.get( `${this.$uri}/student/${element.id}` )
            .then( response =>
            {
        ...
        updateEvent( e )
        {
            ...
            this.axios.put( `${this.$uri}/student/${this.element.id}`, data )
            .then( response =>
            {
                this.modal.hide()
