<template>
    <div class="position-absolute container-fluid" v-show="keys.includes( `student.list` )">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6 text-start animate__animated animate__fadeInDown">
                        <h6>
                            <i class="lni lni-map-marker text-success me-2"></i>Estudiantes
                        </h6>
                    </div>
                    <div class="col-6 text-end mb-4">
                        ...
                        <button class="btn btn-sm btn-success mb-0" v-show="keys.includes( `student.store` )" @click="$refs.StoreComponent.store()">
                ...
                <div class="row position-relative" id="studentArea">
                    <table-component
                    :data="list.data"
...
export default
{
    ...
    mounted()
    {
        this.area = document.getElementById( `studentArea` )
    },
    ...
    methods:
    {
        listing()
        {
            ...
            this.axios.post( `${this.$uri}/student/list?page=${this.page}`, this.filters )
            .then( response =>
            {
