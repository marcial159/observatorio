                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-5">
                                ...
                                <input type="text" name="program" class="form-control form-control-sm" maxlength="30" autocomplete="off" required>
                                <p error="program" class="error"></p>
                            </div>
                            <div class="col-7">
                                <label class="form-label">Nombre (*)</label>
                                <input type="text" name="name" class="form-control form-control-sm" maxlength="40" autocomplete="off" required>
...
export default
{
    ...
    methods:
    {
        ...
        storeEvent( e )
        {
            ...
            vuenisimo.clearError( this.form )
            this.axios.post( `${this.$uri}/investigation_student`, data )
            .then( response =>
            {
                vuenisimo.clearData( this.form )
                this.modal.hide()
