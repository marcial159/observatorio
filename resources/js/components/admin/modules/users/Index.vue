            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 text-start animate__animated animate__fadeInDown">
                        <h6>
                            <i class="lni lni-users text-success me-2"></i>Usuarios
                        </h6>
                    </div>
                    <div class="col-6 text-end mb-4">
                        ...
                        <button type="button" class="btn btn-sm btn-success mb-0" v-show="keys.includes( `user.store` )" @click="$refs.StoreComponent.store()">
...
export default
{
    ...
    methods:
    {
        resources()
        {
            this.axios.post( `${this.$uri}/user/resources` )
            .then( response => 
            {
        ...
        async listing()
        {
            ...
            await this.axios.post( `${this.$uri}/user/list?page=${this.page}`, this.filters )
            .then( response => {
