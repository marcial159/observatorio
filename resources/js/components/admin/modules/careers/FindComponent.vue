    ...
    <form :id="`${id}Form`">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6">
                ...
                <input @input="writing" type="text" name="program" class="form-control form-control-sm" autocomplete="off">
            </div>
            <div class="col-md-2 col-sm-6">
                <label class="form-label">Nombre</label>
                <input @input="writing" type="text" name="name" class="form-control form-control-sm" autocomplete="off">
            </div>
            <div class="col-md-2 col-sm-6">
                <label class="form-label">Acronym</label>
                <input @input="writing" type="text" name="acronym" class="form-control form-control-sm" autocomplete="off">
            </div>
        </div>
    </form>
</template>
