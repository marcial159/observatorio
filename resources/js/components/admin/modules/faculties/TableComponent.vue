            ...
            <table class="table table-hover align-items-center mb-0">
                ...
                <tbody>
                    <tr v-if="data?.length > 0" v-for="( element, index ) in data" :key="index">
                        ...
                        <td class="align-middle text-center" v-show="keys.includes( `faculty.update` ) || keys.includes( `faculty.destroy` )">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropMenu">
                                <li class="cursor-pointer">
                                    <a class="dropdown-item" v-show="keys.includes( `faculty.update` )" @click="$emit( `update`, element )">
                                        <i class="lni lni-pencil-alt me-2"></i>Modificar
                                    </a>
                                </li>
                                <li class="cursor-pointer">
                                    <a class="dropdown-item" v-show="keys.includes( `faculty.destroy` )" @click="$emit( `destroy`, element )">
