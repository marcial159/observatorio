            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 text-start animate__animated animate__fadeInDown">
                        <h6>
                            <i class="lni lni-users text-success me-2"></i>ADMINISTRACIÓN DE CATEGORIAS DE PROYECTOS
                        </h6>
                    </div>
                ...
                <div class="row position-relative" id="categoryArea">
...
export default
    {
        ...
        mounted() {
            this.area = document.getElementById(`categoryArea`)
        },
        ...
        methods:
        {
            ...
            async listing() {
                ...
                await this.axios.post(`${this.$uri}/project-category/list?page=${this.page}`, this.filters)
                    .then(response => {
