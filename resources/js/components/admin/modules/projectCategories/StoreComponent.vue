<template>
    <div class="modal fade" id="categoryStoreModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form @submit="storeEvent" id="categoryForm" class="position-relative">
                        <div class="row">
...
export default
    {
        ...
        mounted() {
            this.modal = new bootstrap.Modal(document.getElementById(`categoryStoreModal`))
        ...
        methods:
        {
            ...
            storeEvent(e) {
                ...
                this.axios.post(`${this.$uri}/project-category`, data)
                    .then(response => {
                        vuenisimo.clearData(this.form)
                        this.modal.hide()
