                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                ...
                                <input type="text" name="position" class="form-control form-control-sm" maxlength="40" autocomplete="off" required>
                                <p error="position" class="error"></p>
                            </div>
                        </div>
                        <div class="row">
...
export default
{
    ...
    methods:
    {
        update( element )
        {
            ...
            this.axios.get( `${this.$uri}/headquarter/${element.id}` )
            .then( response =>
            {
        ...
        updateEvent( e )
        {
            ...
            this.axios.put( `${this.$uri}/headquarter/${this.element.id}`, data )
            .then( response =>
            {
                this.modal.hide()
