            ...
            <table class="table table-hover align-items-center mb-0">
                <thead class="bg-th">
                    <tr>
                        ...
                        <th class="col-6 text-uppercase text-xxs font-weight-bolder text-center" role="button" @click="$emit( `order`, `position` )">
                            Ubicación
                            <i class="lni lni-arrows-vertical"></i>
                        </th>
                ...
                <tbody>
                    <tr v-if="data?.length > 0" v-for="( element, index ) in data" :key="index">
                        ...
                        <td class="align-middle text-center animate__animated animate__fadeIn">
                            <small class="mb-0 text-xs">{{ element.position  }}</small>
                        </td>
                        <td class="align-middle text-center animate__animated animate__fadeIn">
                        ...
                        <td class="align-middle text-center" v-show="keys.includes( `headquarter.update` ) || keys.includes( `headquarter.destroy` )">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropMenu">
                                <li class="cursor-pointer">
                                    <a class="dropdown-item" v-show="keys.includes( `headquarter.update` )" @click="$emit( `update`, element )">
                                        <i class="lni lni-pencil-alt me-2"></i>Modificar
                                    </a>
                                </li>
                                <li class="cursor-pointer">
                                    <a class="dropdown-item" v-show="keys.includes( `headquarter.destroy` )" @click="$emit( `destroy`, element )">
