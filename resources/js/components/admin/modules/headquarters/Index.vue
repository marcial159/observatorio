<template>
    <div class="position-absolute container-fluid" v-show="keys.includes( `headquarter.list` )">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6 text-start animate__animated animate__fadeInDown">
                        <h6>
                            <i class="lni lni-map-marker text-success me-2"></i>Sedes
                        </h6>
                    </div>
                    <div class="col-6 text-end mb-4">
                        ...
                        <button class="btn btn-sm btn-success mb-0" v-show="keys.includes( `headquarter.store` )" @click="$refs.StoreComponent.store()">
                ...
                <div class="row position-relative" id="headquarterArea">
                    <table-component
                    :data="list.data"
        ...
        />
        <update-component
        id="UpdateHeadquarter"
        ref="UpdateComponent"
        @row="e => replace( list.data, e )"
        />
        <destroy-component
        id="DestroyHeadquarter"
...
export default
{
    ...
    mounted()
    {
        this.area = document.getElementById( `headquarterArea` )
    },
    ...
    methods:
    {
        listing()
        {
            ...
            this.axios.post( `${this.$uri}/headquarter/list?page=${this.page}`, this.filters )
            .then( response =>
            {
